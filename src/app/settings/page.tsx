...
export default function SettingsPage() {
  ...
  const [profile, setProfile] = useState({
    ...
    phone: "+31 6 12345678",
    bio: "Op zoek naar een mooie woning in Amsterdam of omgeving."
  });
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-blue-600 text-white py-8">
        <div className="container mx-auto px-4">
          <h1 className="text-2xl sm:text-3xl font-bold mb-2">Instellingen</h1>
          <p className="text-blue-100">Beheer je account en voorkeuren</p>
        </div>
      </div>
            ...
            <div className="p-4 border-t border-gray-200 space-y-4">
              ...
              <div className="flex items-center gap-4">
                <div className="relative">
                  <div className="w-20 h-20 rounded-full bg-blue-600 flex items-center justify-center text-white font-semibold text-xl overflow-hidden">
                    JJ
                  </div>
                  <button className="absolute -bottom-1 -right-1 p-1.5 bg-blue-600 rounded-full text-white hover:bg-blue-700 transition-colors">
                    <Camera size={14} />
                  </button>
                </div>
                <div>
              ...
              <div className="space-y-4">
                ...
                <button className="w-full sm:w-auto bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition-colors flex items-center gap-2">
                  <Save size={16} />
                  Opslaan
                </button>
              </div>
